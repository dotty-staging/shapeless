...
object Typeable extends Typeable0 {
  ...
  given Typeable[Byte] as byteTypeable = ValueTypeable[Byte, jl.Byte](classOf[jl.Byte], "Byte")
  /** Typeable instance for `Short`. */
  given Typeable[Short] as shortTypeable = ValueTypeable[Short, jl.Short](classOf[jl.Short], "Short")
  /** Typeable instance for `Char`. */
  given Typeable[Char] as charTypeable = ValueTypeable[Char, jl.Character](classOf[jl.Character], "Char")
  /** Typeable instance for `Int`. */
  given Typeable[Int] as intTypeable = ValueTypeable[Int, jl.Integer](classOf[jl.Integer], "Int")
  /** Typeable instance for `Long`. */
  given Typeable[Long] as longTypeable = ValueTypeable[Long, jl.Long](classOf[jl.Long], "Long")
  /** Typeable instance for `Float`. */
  given Typeable[Float] as floatTypeable = ValueTypeable[Float, jl.Float](classOf[jl.Float], "Float")
  /** Typeable instance for `Double`. */
  given Typeable[Double] as doubleTypeable = ValueTypeable[Double, jl.Double](classOf[jl.Double], "Double")
  /** Typeable instance for `Boolean`. */
  given Typeable[Boolean] as booleanTypeable = ValueTypeable[Boolean, jl.Boolean](classOf[jl.Boolean], "Boolean")
  /** Typeable instance for `Unit`. */
  given Typeable[Unit] as unitTypeable = ValueTypeable[Unit, scala.runtime.BoxedUnit](classOf[scala.runtime.BoxedUnit], "Unit")
   ...
   */
  given [CC[t] <: Iterable[t], T] => (CCTag: ClassTag[CC[Any]], tt: Typeable[T]) => Typeable[CC[T]] as iterableTypeable {
    def castable(t: Any): Boolean =
      t match {
   ...
   */
  given [M[k, v] <: Map[k, v], K, V] => (MTag: ClassTag[M[Any, Any]], tk: Typeable[K], tv: Typeable[V]) => Typeable[M[K, V]] as mapTypeable {
    def castable(t: Any): Boolean =
      t match {
