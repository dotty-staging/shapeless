...
object K0 {
  type Kind[C <: Mirror, O] = C { type Kind = K0.type ; type MirroredType = O ; type MirroredElemTypes }
...
object K1 {
  type Kind[C <: Mirror, O[_]] = C { type Kind = K1.type ; type MirroredType = O ; type MirroredElemTypes[_] }
...
object K11 {
  type Kind[C <: Mirror, O[_[_]]] = C { type Kind = K11.type ; type MirroredType = O ; type MirroredElemTypes[_[_]] }
...
object K2 {
  type Kind[C <: Mirror, O[_, _]] = C { type Kind = K2.type ; type MirroredType = O ; type MirroredElemTypes[_, _] }
  type Generic[O[_, _]] = Kind[Mirror, O]
  type ProductGeneric[O[_, _]] = Kind[Mirror.Product, O]
  type CoproductGeneric[O[_, _]] = Kind[Mirror.Sum, O]
